...
public class BoyerMoore {
    ...
    public static void main(String[] args) {
        String  txt = "AJSDKANKJD JSKABDJKASBKJBSJKDBJKABSJKDBJAKSBDJKASBDJKSABGGAHAHARAKARKHAMAHAHHAHA";
        String pat = "ARKHAM";
        ...
        System.out.println(boyermoore1.contains(txt));
